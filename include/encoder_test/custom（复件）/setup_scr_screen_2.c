...
void setup_scr_screen_2(lv_ui *ui)
{
	...
	lv_img_set_src(ui->screen_2_img_1, &_ni2_alpha_240x240);
	...
	lv_label_set_text(ui->screen_2_btn_1_label, "show2");
	...
	lv_obj_set_pos(ui->screen_2_btn_1, 101, 220);
	lv_obj_set_size(ui->screen_2_btn_1, 60, 20);
	...
	lv_obj_set_style_bg_color(ui->screen_2_btn_1, lv_color_hex(0xFFAA00), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_2_btn_1, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_2_btn_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_main_stop(ui->screen_2_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_stop(ui->screen_2_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
