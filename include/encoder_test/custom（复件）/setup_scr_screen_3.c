...
void setup_scr_screen_3(lv_ui *ui)
{
	...
	lv_label_set_text(ui->screen_3_btn_1_label, "show3");
	...
	lv_obj_set_pos(ui->screen_3_btn_1, 100, 220);
	lv_obj_set_size(ui->screen_3_btn_1, 60, 20);
	...
	lv_obj_set_style_bg_color(ui->screen_3_btn_1, lv_color_hex(0xFFAA00), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_3_btn_1, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_3_btn_1, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
